...
import AlexCosta from '../../assets/AlexCosta.jpeg'
    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
      ...
      <div className='subscribed-list'>
        ...
        <div className='side-link'>
          <img src={AlexCosta} alt="" /><p>Alex Costa</p>
        </div>
        <div className='side-link'>
          <img src={Mahadev} alt="" /><p>Mahadev Sunil</p>
        </div>
        <div className='side-link'>
          <img src={WWE} alt="" /><p>WWE</p>
        </div>
        <div className='side-link'>
          <img src={brandon} alt="" /><p>Brandon balfour</p>
        </div>
        <div className='side-link'>
